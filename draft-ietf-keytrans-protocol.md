...
which is not the case. In practice, binary ladders are always executed with
...
entries that have passed their maximum lifetime will still be needed by users and
